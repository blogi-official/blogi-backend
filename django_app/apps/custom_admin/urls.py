...
urlpatterns = [
    ...
    path("generated/<int:id>", GeneratedPostDetailAPIView.as_view(), name="admin-generated-post-detail"),
    path("generated/<int:id>/manage", GeneratedPostDeactivateOrDeleteAPIView.as_view()),
    # 유저 관리
    ...
    path(
        "users/<int:user_id>/generated", AdminUserGeneratedPostListAPIView.as_view(), name="admin-user-generated-posts"
    ),
    # 대시보드
    path("dashboard/daily-stats", DailyStatsAPIView.as_view(), name="daily-stats"),
    path("dashboard/top-keywords", TopKeywordAPIView.as_view(), name="admin_dashboard_top_keywords"),
    path("dashboard/clova-stats", ClovaStatsAPIView.as_view()),
]
